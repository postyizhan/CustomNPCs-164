...
public class ModelTail extends ModelScaleRenderer {
	...
	public void setRotationAngles(float par1, float par2, float par3,
        ...
        if(this.entity.legParts.type == 2){
        	rotationPointY = 13f;
        	rotationPointZ = 14 * this.entity.legs.scaleZ;

	        if(base.isSleeping(entity) || this.entity.currentAnimation == EnumAnimation.CRAWLING){
	        	rotationPointY = 12 + 16 * this.entity.legs.scaleZ;
	        	rotationPointZ = 1f * this.entity.legs.scaleY;
        	...
        	rotationPointY = 8.6f;
        	rotationPointZ = 19 * this.entity.legs.scaleZ;
        }
        else{
        	rotationPointY = 11;
