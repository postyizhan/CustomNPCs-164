...
public class BlockSignRenderer extends BlockRendererInterface{
    ...
    {
        if (iicon.getItemSpriteNumber() == 0 && RenderBlocks.renderItemIn3d(Block.blocksList[iicon.getItem().itemID].getRenderType()))
        	return;
        GL11.glPushMatrix();
    	...
    	renderer.renderItemIntoGUI(this.getFontRenderer(), mc.renderEngine, iicon, -8, -8);
