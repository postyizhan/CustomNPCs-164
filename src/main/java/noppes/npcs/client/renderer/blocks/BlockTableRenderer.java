...
public class BlockTableRenderer extends BlockRendererInterface{
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4,
        ...
        boolean south = var1.getWorldObj().getBlockId(var1.xCoord + 1, var1.yCoord, var1.zCoord) == CustomItems.table.blockID;
        boolean north = var1.getWorldObj().getBlockId(var1.xCoord - 1, var1.yCoord, var1.zCoord) == CustomItems.table.blockID;
        boolean east = var1.getWorldObj().getBlockId(var1.xCoord, var1.yCoord, var1.zCoord + 1) == CustomItems.table.blockID;
        boolean west = var1.getWorldObj().getBlockId(var1.xCoord, var1.yCoord, var1.zCoord - 1) == CustomItems.table.blockID;
