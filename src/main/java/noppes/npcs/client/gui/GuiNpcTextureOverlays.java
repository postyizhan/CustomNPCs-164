...
public class GuiNpcTextureOverlays extends GuiNPCInterface implements GuiNpcSkinPreviewInterface
{
	private GuiNPCStringSlot slot;
	private GuiScreen parent;
	private String root = "/customnpcs/textures/overlays";
    ...
    public GuiNpcTextureOverlays(EntityNPCInterface npc,GuiScreen parent)
    {
    	...
    	if(!npc.display.glowTexture.isEmpty())
    		root = AssetsBrowser.getRoot(npc.display.glowTexture);
