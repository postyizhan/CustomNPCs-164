...
public class GuiMerchantAdd extends GuiContainer
{
    ...
    {
        super(new ContainerMerchantAdd(Minecraft.getMinecraft().thePlayer.inventory, ItemInteractEvent.Merchant, Minecraft.getMinecraft().theWorld));
        this.theIMerchant = ItemInteractEvent.Merchant;
        this.field_94082_v = I18n.getString("entity.Villager.name");
    }
