...
public class GuiNpcAdvanced extends GuiNPCInterface2 implements IGuiData
{
    ...
    public void initGui()
    {
    	...
    	this.addButton(new GuiNpcButton(8, guiLeft + 85, guiTop + 20,155,20, new String[]{"role.none","role.trader","role.follower","role.bank","role.transporter", "role.mailman"},npc.advanced.role.ordinal()));
