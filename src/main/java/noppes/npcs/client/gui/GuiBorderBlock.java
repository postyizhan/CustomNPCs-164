...
public class GuiBorderBlock extends GuiNPCInterface implements IGuiData{
    ...
    public GuiBorderBlock(int x, int y, int z) {
		super();
		tile = (TileBorder) player.worldObj.getBlockTileEntity(x, y, z);
		
		NoppesUtil.sendData(EnumPacketType.GetTileEntity, x, y, z);
	}
	public void initGui()
    {
    	super.initGui();
    	...
    	addTextField(new GuiNpcTextField(0, this, fontRenderer, guiLeft+ 60, guiTop + 71,40,20, tile.height + ""));
    	...
    	addTextField(new GuiNpcTextField(1, this, this.fontRenderer, guiLeft+ 60, guiTop + 95,200,20, tile.message));
