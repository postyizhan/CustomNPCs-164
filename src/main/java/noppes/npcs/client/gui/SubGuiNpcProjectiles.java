...
public class SubGuiNpcProjectiles extends SubGuiInterface implements ITextfieldListener
{
    ...
    {
        super.initGui();
        addLabel(new GuiNpcLabel(1,"enchantment.arrowDamage", guiLeft + 5, guiTop + 15, 0x404040));
        addTextField(new GuiNpcTextField(1,this, fontRenderer, guiLeft + 45, guiTop + 10, 50, 18, stats.pDamage+""));
        getTextField(1).numbersOnly = true;
        getTextField(1).setMinMaxDefault(0, 9999, 5);
        addLabel(new GuiNpcLabel(2,"enchantment.arrowKnockback", guiLeft + 110, guiTop + 15, 0x404040));
        addTextField(new GuiNpcTextField(2,this, fontRenderer, guiLeft + 150, guiTop + 10, 50, 18, stats.pImpact+""));
        getTextField(2).numbersOnly = true;
        getTextField(2).setMinMaxDefault(0, 3, 0);
        addLabel(new GuiNpcLabel(3,"stats.size", guiLeft + 5, guiTop + 45, 0x404040));
        addTextField(new GuiNpcTextField(3,this, fontRenderer, guiLeft + 45, guiTop + 40, 50, 18, stats.pSize+""));
        getTextField(3).numbersOnly = true;
        getTextField(3).setMinMaxDefault(1, 10, 10);
        addLabel(new GuiNpcLabel(4,"stats.speed", guiLeft + 5, guiTop + 75, 0x404040));
        addTextField(new GuiNpcTextField(4,this, fontRenderer, guiLeft + 45, guiTop + 70, 50, 18, stats.pSpeed+""));
        getTextField(4).numbersOnly = true;
        getTextField(4).setMinMaxDefault(1, 50, 10);
        
        addLabel(new GuiNpcLabel(5,"stats.hasgravity", guiLeft + 5, guiTop + 105, 0x404040));
    	...
    	addLabel(new GuiNpcLabel(6,"stats.explosive", guiLeft + 5, guiTop + 135, 0x404040));
    	...
    	addLabel(new GuiNpcLabel(7,"stats.rangedeffect", guiLeft + 5, guiTop + 165, 0x404040));
    	...
    	if(stats.pEffect != EnumPotionType.None) {
    		addTextField(new GuiNpcTextField(5,this, fontRenderer, guiLeft + 140, guiTop + 160, 60, 18, stats.pDur + ""));
    	...
    	addLabel(new GuiNpcLabel(8,"stats.trail", guiLeft + 5, guiTop + 195, 0x404040));
    	...
    	if (stats.pRender3D) {
    		addLabel(new GuiNpcLabel(10,"stats.spin", guiLeft + 160, guiTop + 45, 0x404040));
    		addButton(new GuiNpcButton(8, guiLeft + 220, guiTop + 40, 30, 20, new String[]{"gui.no", "gui.yes"} ,stats.pSpin ? 1:0));
    		addLabel(new GuiNpcLabel(11,"stats.stick", guiLeft + 160, guiTop + 75, 0x404040));
    		addButton(new GuiNpcButton(9, guiLeft + 220, guiTop + 70, 30, 20, new String[]{"gui.no", "gui.yes"} ,stats.pStick ? 1:0));
    	}
    	addButton(new GuiNpcButton(6, guiLeft + 140, guiTop + 190, 60, 20, new String[]{"Glow", "No glow"} ,stats.pGlows ? 1:0));
