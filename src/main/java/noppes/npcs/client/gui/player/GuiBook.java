...
public class GuiBook extends GuiScreen
{
    ...
    public GuiBook(EntityPlayer par1EntityPlayer, ItemStack item, int x, int y, int z){
        ...
        this.itemstackBook = item;
        this.bookIsUnsigned = item.getItem() == Item.writableBook;
    ...
    private void sendBookToServer(boolean par1)
    {
        if (this.bookIsUnsigned && this.bookModified)
        {
            if (this.bookPages != null)
            {
                ...
                NoppesUtilPlayer.sendData(EnumPlayerPacket.SaveBook, x, y, z, par1, itemstackBook.writeToNBT(new NBTTagCompound()));
