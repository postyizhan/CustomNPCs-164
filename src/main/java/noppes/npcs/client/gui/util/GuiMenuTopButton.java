...
public class GuiMenuTopButton extends GuiButton
{
    ...
    public void drawButton(Minecraft minecraft, int i, int j)
    {
        ...
        drawTexturedModalRect(xPosition, yPosition, 0,  k * 20, width / 2, height);
        drawTexturedModalRect(xPosition + width / 2, yPosition, 200 - width / 2,  k * 20, width / 2, height);
    ...
    {
    	boolean bo = !active && drawButton && hover;
    	if(bo && listener != null){
