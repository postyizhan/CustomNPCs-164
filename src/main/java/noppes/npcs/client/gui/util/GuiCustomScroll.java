...
//            GuiScreen, EntityList, TileEntityMobSpawner, EntityLiving, 
//            World, RenderEngine, RenderHelper, FontRenderer

public class GuiCustomScroll extends GuiScreen
{
	private final ResourceLocation resource = new ResourceLocation("customnpcs","textures/gui/misc.png");
        ...
        for(int i = 0; i < list.size(); i++)
        {
            ...
            if(k >= 4 && k + 12 < ySize)
            {
            	...
            	if((multipleSelection && selectedList.contains(text)) || (!multipleSelection && selected == i)) {
            		...
            		drawVerticalLine(j + xSize - 20, k-4, k + 10, 0xffffffff);
            		drawHorizontalLine(j - 2, j + xSize - 20, k - 3 , 0xffffffff);
            		drawHorizontalLine(j - 2, j + xSize - 20, k + 10 , 0xffffffff);
