...
public class SubGuiNpcMeleeProperties extends SubGuiInterface implements ITextfieldListener
{
    ...
    {
        super.initGui();
        addLabel(new GuiNpcLabel(1,"stats.meleestrength", guiLeft + 5, guiTop + 15, 0x404040));
        addTextField(new GuiNpcTextField(1,this, fontRenderer, guiLeft + 85, guiTop + 10, 50, 18, stats.attackStrength+""));
        getTextField(1).numbersOnly = true;
        getTextField(1).setMinMaxDefault(0, 99999, 5);
        addLabel(new GuiNpcLabel(2,"stats.meleerange", guiLeft + 5, guiTop + 45, 0x404040));
        addTextField(new GuiNpcTextField(2,this, fontRenderer, guiLeft + 85, guiTop + 40, 50, 18, stats.attackRange+""));
        getTextField(2).numbersOnly = true;
        getTextField(2).setMinMaxDefault(1, 30, 2);
        addLabel(new GuiNpcLabel(3,"stats.meleespeed", guiLeft + 5, guiTop + 75, 0x404040));
        addTextField(new GuiNpcTextField(3,this, fontRenderer, guiLeft + 85, guiTop + 70, 50, 18, stats.attackSpeed+""));
        getTextField(3).numbersOnly = true;
        getTextField(3).setMinMaxDefault(1, 1000, 20);


        addLabel(new GuiNpcLabel(4,"enchantment.knockback", guiLeft + 5, guiTop + 105, 0x404040));
		addTextField(new GuiNpcTextField(4,this, fontRenderer, guiLeft + 85, guiTop + 100, 50, 18, stats.knockback + ""));
		getTextField(4).numbersOnly = true;
		getTextField(4).setMinMaxDefault(0, 4, 0);
        addLabel(new GuiNpcLabel(5,"stats.meleeeffect", guiLeft + 5, guiTop + 135, 0x404040));
    	...
    	if(stats.potionType != EnumPotionType.None) {
    		addLabel(new GuiNpcLabel(6,"gui.time", guiLeft + 5, guiTop + 165, 0x404040));
    		addTextField(new GuiNpcTextField(6,this, fontRenderer, guiLeft + 85, guiTop + 160, 50, 18, stats.potionDuration + ""));
    		getTextField(6).numbersOnly = true;
    		getTextField(6).setMinMaxDefault(1, 99999, 5);
    		if(stats.potionType != EnumPotionType.Fire) {
    			addLabel(new GuiNpcLabel(7,"stats.amplify", guiLeft + 5, guiTop + 195, 0x404040));
	...
	public void unFocused(GuiNpcTextField textfield) {
		if(textfield.id == 1){
			stats.attackStrength = textfield.getInteger();
		}
