...
public class SubGuiNpcFactionOptions extends SubGuiInterface implements IScrollData,GuiCustomScrollActionListener
{
    ...
    public void initGui()
    {
        ...
        addLabel(new GuiNpcLabel(0, "1: ", guiLeft + 4,  guiTop + 12, 0x404040));
        if(data.containsValue(options.factionId)){
            addLabel(new GuiNpcLabel(1, getFactionName(options.factionId), guiLeft + 12,  guiTop + 8, 0x404040));
            ...
            addLabel(new GuiNpcLabel(3, label, guiLeft + 12,  guiTop + 16, 0x404040));
            addButton(new GuiNpcButton(0, guiLeft + 110, guiTop + 7, 20, 20, "X"));
        }

        addLabel(new GuiNpcLabel(4, "2: ", guiLeft + 4,  guiTop + 40, 0x404040));
        if(data.containsValue(options.faction2Id)){
            addLabel(new GuiNpcLabel(5, getFactionName(options.faction2Id), guiLeft + 12,  guiTop + 36, 0x404040));
            ...
            addLabel(new GuiNpcLabel(6, label, guiLeft + 12,  guiTop + 44, 0x404040));
        ...
        if(selected >= 0 && (!data.containsValue(options.faction2Id) || !data.containsValue(options.factionId)) && !options.hasFaction(selected)){
            ...
            addTextField(new GuiNpcTextField(1, this, fontRenderer, guiLeft + 4, guiTop + 82, 110, 20, "10"));
