...
public class SubGuiNpcConversationLine extends SubGuiInterface implements ITextfieldListener{
    ...
    public void initGui(){
        ...
        addLabel(new GuiNpcLabel(0, "Line", guiLeft + 4, guiTop+ 10, 0x404040));
        ...
        addLabel(new GuiNpcLabel(1, sound, guiLeft + 4, guiTop + 81, 0x404040));
	...
	protected void actionPerformed(GuiButton guibutton){
        if(guibutton.id == 1){
        	NoppesUtil.openGUI(player, gui = new GuiNpcMusicSelection(npc, parent, sound));
        }
        if(guibutton.id == 2){
        	sound = "";
        	initGui();
