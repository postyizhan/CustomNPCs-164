...
{	
    ...
    public void initGui(){
    	...
    	addLabel(new GuiNpcLabel(40, "gui.name", guiLeft + 40, guiTop + 4, 0x404040));
    	addLabel(new GuiNpcLabel(41, "gui.name", guiLeft + 240, guiTop + 4, 0x404040));
    	
    	addLabel(new GuiNpcLabel(42, "conversation.delay", guiLeft + 164, guiTop + 4, 0x404040));
    	addLabel(new GuiNpcLabel(43, "conversation.delay", guiLeft + 364, guiTop + 4, 0x404040));

		for (int i = 0; i < 14; i++) {
    		ConversationLine line = job.getLine(i);
			int offset = i >=7 ?200:0;
			this.addLabel(new GuiNpcLabel(i, "" + i, guiLeft + 5 + offset - (i > 9?6:0), guiTop + 18 + i % 7 * 22, 0x000000));
			this.addTextField(new GuiNpcTextField(i, this, this.fontRenderer, guiLeft + 13 + offset, guiTop + 13 +  i % 7 * 22, 100, 20, line.npc));
			this.addButton(new GuiNpcButton(i, guiLeft + 115 + offset, guiTop + 13 + i % 7 * 22, 46, 20, "conversation.line"));
			
			if(i == 13)
				break;
			this.addTextField(new GuiNpcTextField(i + 14, this, this.fontRenderer, guiLeft + 164 + offset, guiTop + 13 + i % 7 * 22, 30, 20, line.delay + ""));
			this.getTextField(i + 14).numbersOnly = true;
			this.getTextField(i + 14).setMinMaxDefault(5, 1000, 40);
		}
		addLabel(new GuiNpcLabel(50, "conversation.delay", guiLeft + 205, guiTop + 175, 0x404040));
		addTextField(new GuiNpcTextField(50, this, fontRenderer, guiLeft + 270, guiTop + 170, 50, 20, job.generalDelay + ""));
		getTextField(50).numbersOnly = true;
		getTextField(50).setMinMaxDefault(10, 1000000, 12000);

		addLabel(new GuiNpcLabel(54, "gui.range", guiLeft + 205, guiTop + 196, 0x404040));
		addTextField(new GuiNpcTextField(54, this, fontRenderer, guiLeft + 270, guiTop + 191, 50, 20, job.range + ""));
		getTextField(54).numbersOnly = true;
		getTextField(54).setMinMaxDefault(4, 60, 20);
		
		addLabel(new GuiNpcLabel(51, "quest.quest", guiLeft + 13, guiTop + 175, 0x404040));
		...
		addLabel(new GuiNpcLabel(53, "availability.name", guiLeft + 13, guiTop + 196, 0x404040));
