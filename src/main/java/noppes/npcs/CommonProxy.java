...
public class CommonProxy implements IGuiHandler {
	...
	public Container getContainer(EnumGuiType gui,EntityPlayer player, int x, int y, int z,EntityNPCInterface npc){
		...
		if(gui == EnumGuiType.MerchantAdd)
			return new ContainerMerchantAdd(player.inventory, ItemInteractEvent.Merchant, player.worldObj);

		if(gui == EnumGuiType.Crate)
			return new ContainerCrate(player.inventory, (TileNpcContainer)player.worldObj.getBlockTileEntity(x, y, z));
		return null;
	}
