...
public class BlockWallBanner extends BlockNpcContainerInterface{
    ...
    public boolean onBlockActivated(World par1World, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9){
    	...
    	if(item == null)
    		return false;
    	TileWallBanner tile = (TileWallBanner) par1World.getBlockTileEntity(i, j, k);
    	if(tile.canEdit())
    		return true;
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        l %= 4;
    	TileWallBanner tile = (TileWallBanner) par1World.getBlockTileEntity(par2, par3, par4);
    	tile.rotation = l;
