...
public class BlockTombstone extends BlockNpcContainerInterface{
    ...
    public boolean onBlockActivated(World par1World, int i, int j, int k, EntityPlayer player, int par6, float par7, float par8, float par9){
		...
		if (currentItem != null	&& currentItem.getItem() == CustomItems.wand) {
			TileBigSign tile = (TileBigSign) par1World.getBlockTileEntity(i, j, k);
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack){
        ...
        TileBigSign tile = (TileBigSign) par1World.getBlockTileEntity(par2, par3, par4);
    	tile.rotation = l;
    	
        par1World.setBlockMetadataWithNotify(par2, par3, par4, par6ItemStack.getItemDamage() , 2);

    	if(par5EntityLivingBase instanceof EntityPlayer && !par1World.isRemote && par6ItemStack.getItemDamage() < 2){
    		NoppesUtilServer.sendOpenGui((EntityPlayer) par5EntityLivingBase, EnumGuiType.BigSign, null,par2, par3, par4);
    	}
    }
    ...
    {
        return Block.stone.getIcon(p_149691_1_, meta);
    }
