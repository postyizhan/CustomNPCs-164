...
public abstract class TileNpcContainer extends TileColorable implements IInventory {
	...
	public String getInvName() {
		return isInvNameLocalized()?customName:getName();
	}
	...
	public boolean isUseableByPlayer(EntityPlayer player) {
        return player.isDead || this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord) != this ? false : player.getDistanceSq((double)this.xCoord + 0.5D, (double)this.yCoord + 0.5D, (double)this.zCoord + 0.5D) <= 64.0D;
	}
