...
public class ContainerCarpentryBench extends Container
{
    ...
    public ContainerCarpentryBench(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
        ...
        for (var6 = 0; var6 < 4; ++var6)
        {
            ...
            {
                this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 4, 17 + var7 * 18, 8 + var6 * 18));
            }
        }
    ...
    public void onCraftMatrixChanged(IInventory par1IInventory)
    {
    	if(!this.worldObj.isRemote){
    		...
    		plmp.playerNetServerHandler.sendPacketToPlayer(new Packet103SetSlot(this.windowId, 0, item));
    	}
    }
    ...
    {
        return this.worldObj.getBlockId(this.posX, this.posY, this.posZ) != CustomItems.carpentyBench.blockID ? false : par1EntityPlayer.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
