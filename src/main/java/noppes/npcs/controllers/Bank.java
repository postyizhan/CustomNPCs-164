...
public class Bank {
	...
	public void writeEntityToNBT(NBTTagCompound nbttagcompound) {
    	...
    	nbttagcompound.setCompoundTag("BankCurrency", currencyInventory.getToNBT());
    	nbttagcompound.setCompoundTag("BankUpgrade", upgradeInventory.getToNBT());
	...
	public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
        ...
        slotTypes = NBTTags.getIntegerIntegerMap(nbttagcompound.getTagList("BankTypes"));
