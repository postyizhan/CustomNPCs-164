...
public class FactionController {
	...
	public FactionController(){
		...
		loadFactions();
		if(factions.isEmpty()){
			factions.put(0,new Faction(0,"Friendly", 0x00FF00, 2000));
			factions.put(1,new Faction(1,"Neutral", 0xF2FF00, 1000));
			factions.put(2,new Faction(2,"Aggressive", 0xFF0000, 0));
		}
	...
	public void loadFactions(DataInputStream stream) throws IOException{
        ...
        NBTTagList list = nbttagcompound1.getTagList("NPCFactions");
