...
public class BankData {
	...
	public void readNBT(NBTTagCompound nbttagcompound) {
        ...
        itemSlots = getItemSlots(nbttagcompound.getTagList("BankInv"));
        upgradedSlots = NBTTags.getBooleanList(nbttagcompound.getTagList("UpdatedSlots"));
	}
	...
	private NBTTagList nbtItemSlots(HashMap<Integer, NpcMiscInventory> items) {
		...
		for(int slot: items.keySet()){
			...
			nbttagcompound.setCompoundTag("BankItems",items.get(slot).getToNBT());
	...
	public void openBankGui(EntityPlayer player, EntityNPCInterface npc, int bankId, int slot) {
    	...
    	if(currency != null){
    		compound.setCompoundTag("Currency", currency.writeToNBT(new NBTTagCompound()));
